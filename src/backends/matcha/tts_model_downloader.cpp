...
TTSModelDownloader::TTSModelDownloader() {
    ...
    if (home) {
        ...
        cache_dir_ = base_cache_dir_ + "matcha-tts/";
    } else {
...
bool TTSModelDownloader::ensureCppJieba() {
    std::string cppjieba_dir = base_cache_dir_ + "cppjieba";
...
bool TTSModelDownloader::ensureCppPinyin() {
    std::string cpp_pinyin_dir = base_cache_dir_ + "cpp-pinyin";
...
std::string TTSModelDownloader::getCppJiebaPath() const {
    return base_cache_dir_ + "cppjieba/dict";
}

std::string TTSModelDownloader::getCppPinyinPath() const {
    return base_cache_dir_ + "cpp-pinyin/res/dict";
}

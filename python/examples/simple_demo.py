...
def main():
    ...
    config = evo_tts.Config.matcha_en()
    engine_en = evo_tts.Engine(config)
    ...
    config_bilingual = evo_tts.Config.matcha_zh_en()
    engine_bilingual = evo_tts.Engine(config_bilingual)
    ...
    evo_tts.synthesize_to_file("这是快速合成", "output_quick.wav")

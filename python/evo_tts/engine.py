...
try:
    from . import _evo_tts as _tts
except ImportError:
    raise ImportError(
        "_evo_tts module not found. Build Python bindings with:\n"
...
class Config:
    ...
    def matcha_zh(model_dir: str = "~/.cache/matcha-tts") -> "Config":
        ...
        Returns:
            Config object for Chinese synthesis (22050Hz)
        """
        config = Config.__new__(Config)
        config._config = _tts.TtsConfig.MatchaZH(str(Path(model_dir).expanduser()))
        return config
    ...
    def matcha_en(model_dir: str = "~/.cache/matcha-tts") -> "Config":
        ...
        Returns:
            Config object for English synthesis (22050Hz)
        """
        config = Config.__new__(Config)
        config._config = _tts.TtsConfig.MatchaEN(str(Path(model_dir).expanduser()))
        return config
    ...
    def matcha_zh_en(model_dir: str = "~/.cache/matcha-tts") -> "Config":
        ...
        Returns:
            Config object for bilingual synthesis (16000Hz)
        """
        config = Config.__new__(Config)
        config._config = _tts.TtsConfig.MatchaZHEN(str(Path(model_dir).expanduser()))
        return config

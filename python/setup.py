...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        # Build arguments
        build_args = ["--config", build_type, "--target", "_evo_tts"]
...
def get_long_description():
    ...
    return "Evo TTS Python bindings for Matcha-TTS"
...
setup(
    ...
    description="Evo TTS (Text-To-Speech) Python bindings",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/muggle/tts",
    packages=find_packages(),
    ext_modules=[CMakeExtension("evo_tts._evo_tts", source_dir="..")],
